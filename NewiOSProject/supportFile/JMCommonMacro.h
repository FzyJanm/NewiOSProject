...
CG_INLINE UIColor * Text_COLOR_LEVEL1() {
    return Hex_Str_COLOR(@"#0F1511");
}

///** 次要字体颜色 */
CG_INLINE UIColor * Text_COLOR_LEVEL2() {
    return Hex_Str_COLOR(@"#787F35");
}
...
///**按钮可选字体颜色*/
CG_INLINE UIColor * Button_ENABLE_TEXTCOLOR() {
    return Hex_Str_COLOR(@"#FEFFCC");
}
///**不可选按钮字体颜色*/
CG_INLINE UIColor * Button_UNABLE_TEXTCOLOR() {
    return Hex_Str_COLOR(@"#FDFDEE");
}
///**按钮可用背景颜色*/
CG_INLINE UIColor * Button_ENABLE_BG_COLOR() {
    return Hex_Str_COLOR(@"#0F1511");
}
///**按钮不可用背景颜色*/

CG_INLINE UIColor * Button_UNABLE_BG_COLOR() {
    return Hex_Str_COLOR(@"#B5B7B6");
}

///** 协议字体颜色 */
CG_INLINE UIColor * Agreement_Text_COLOR() {
    return Hex_Str_COLOR(@"#83860C");
}
...
// 字体大小
CG_INLINE UIFont * mediumFont(float font) {
    return [UIFont systemFontOfSize:floor(ScaleW(font)) weight:(UIFontWeightMedium)];
}
// 字体大小
CG_INLINE UIFont * fontWithWeight(float font,UIFontWeight weight) {
    return [UIFont systemFontOfSize:floor(ScaleW(font)) weight:(weight)];
}
