...
//  JMBaseProject
//
//  Created by GBMac on 2022/11/19.
//  Copyright © 2022 liuny. All rights reserved.
//

#import "NSString+JSONLog.h"
...
- (NSString *)wy_jsonlog_descriptionWithLocale:(id)locale{
    ...
    NSString *result = [self jsonPrettyStringEncoded];//转换成JSON格式字符串
...
- (NSString *)wy_jsonlog_descriptionWithLocale:(id)locale indent:(NSUInteger)level {
    ...
    NSString *result = [self jsonPrettyStringEncoded];
