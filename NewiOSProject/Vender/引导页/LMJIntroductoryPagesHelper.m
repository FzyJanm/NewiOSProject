...
+ (void)showIntroductoryPageView:(NSArray<NSString *> *)imageArray
{
    ...
    if (![LMJIntroductoryPagesHelper shareInstance].curIntroductoryPagesView) {
        [LMJIntroductoryPagesHelper shareInstance].curIntroductoryPagesView = [LMJIntroductoryPagesView pagesViewWithFrame:CGRectMake(0, 0, APPW, APPH) images:imageArray];
    }
