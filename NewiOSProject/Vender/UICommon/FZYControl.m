...
+(UIButton *)createButtonWithTitleFont:(UIFont *)font
                            titleColor:(UIColor *)titleColor
            contentHorizontalAlignment:(UIControlContentHorizontalAlignment)horizontalAlignment{
...
+(UIButton*)createButtonWithTitleFont:(UIFont *)font
           ...
           contentHorizontalAlignment:(UIControlContentHorizontalAlignment)horizontalAlignment
                   selectedTitleColor:(UIColor *)selectedColor
                          ...
                          borderWidth:(CGFloat)borderWidth title:(NSString *)title{
   
    UIButton *button=[FZYControl createButtonWithTitleFont:font titleColor:titleColor contentHorizontalAlignment:horizontalAlignment ];
...
+(UIButton *)createButtonWithTitleFont:(UIFont *)font
                            titleColor:(UIColor *)titleColor
            contentHorizontalAlignment:(UIControlContentHorizontalAlignment)horizontalAlignment
                       titleEdgeInsets:(UIEdgeInsets)titleEdgeInsets title:(NSString *)title{

    UIButton *button = [FZYControl createButtonWithTitleFont:font titleColor:titleColor contentHorizontalAlignment:horizontalAlignment titleEdgeInsets:titleEdgeInsets ];
    [button setTitle:title forState:UIControlStateNormal];
...
+(UIButton *)createButtonWithTitleFont:(UIFont *)font
     ...
     UIButton *button =  [FZYControl createButtonWithTitleFont:font titleColor:titleColor contentHorizontalAlignment:horizontalAlignment titleEdgeInsets:titleEdgeInsets title:title];
    [button setTitleColor:selectedColor forState:UIControlStateSelected];
...
+(TPKeyboardAvoidingTableView *)createTPKeyboardAvoidingTableViewWithFrame:(CGRect)frame
                                                                     style:(UITableViewStyle)style
                                                            backgroudColor:(UIColor *)backgroudColor
                                                                dataSource:(id<UITableViewDataSource>)dataSource
                                                                  delegate:(id<UITableViewDelegate>)delegate
