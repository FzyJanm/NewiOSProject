...
-(void)initPickerView{
    ...
    pushImageName = @"ic_action_bk_103";
    
    _pickerCollectionView.scrollEnabled = NO;

    //上传图片提示
    addImageStrLabel = [[UILabel alloc]initWithFrame:CGRectMake(_pickerCollectionView.left, _pickerCollectionView.bottom+15, 152/Scale, 19/Scale)];
    addImageStrLabel.text = @"最多上传9张图片";
