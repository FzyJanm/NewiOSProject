...
//MM-dd
+ (NSString *)getCcurrentMonthAndDateByTimestamp:(NSString *)timestamp {
    NSDate *currentTime = [NSDate dateWithTimeIntervalSince1970:[timestamp doubleValue]/1000];
    NSDateFormatter *formatter = [NSDateFormatter new];
    [formatter setDateFormat:@"MM月-dd日"];
    NSString *showTimeNew = [formatter stringFromDate:currentTime];
...
{
    CGFloat max_width = APPW-150;
    CGFloat max_height = APPW-130;
