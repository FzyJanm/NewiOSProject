...
@class FZYCountdownTask;
NS_ASSUME_NONNULL_BEGIN
@interface FZYButtonCountdownManager : NSObject
 ...
 */
- (BOOL)countdownTaskExistWithKey:(NSString *)akey task:(FZYCountdownTask * _Nullable * _Nullable)task;
