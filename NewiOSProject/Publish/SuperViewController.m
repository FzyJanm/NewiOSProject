...
//    [IQKeyboardManager sharedManager].shouldResignOnTouchOutside = YES;
   ...
   self.navigationController.navigationBarHidden=YES;
    ...
    self.NavImg = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0,self.view.width,NAVGATIONBRHEIGHT)];
...
- (NSString *)getImgStrWithImgUrlStr:(NSString *)imgUrlStr quality:(CGFloat)compressionQuality {
    ...
    [imgv setImageWithURL:imgUrlStr placeholderImage:nil];
